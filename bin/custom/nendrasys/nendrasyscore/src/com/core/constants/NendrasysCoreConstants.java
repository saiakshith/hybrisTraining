...
/**
 * Global class for all NendrasysCore constants. You can add global constants for your extension into this class.
 */
public final class NendrasysCoreConstants extends GeneratedNendrasysCoreConstants
{
	public static final String EXTENSIONNAME = "nendrasyscore";


	private NendrasysCoreConstants()
	{
		//empty
	}
