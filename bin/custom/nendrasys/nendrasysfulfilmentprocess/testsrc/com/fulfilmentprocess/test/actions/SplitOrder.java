 ...
 */
package com.fulfilmentprocess.test.actions;
...
public class SplitOrder extends TestActionTemp
{
	...
	public String execute(final BusinessProcessModel process) throws Exception
	{
		...
		warehouseCounter.setName(NendrasysFulfilmentProcessConstants.CONSIGNMENT_COUNTER);
		...
		params.setName(NendrasysFulfilmentProcessConstants.PARENT_PROCESS);
